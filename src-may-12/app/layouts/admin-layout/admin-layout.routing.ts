...
export const AdminLayoutRoutes: Routes = [
    ...
    children: [
      {
        path: "products",
        loadChildren: () =>
          import("src-may-12/app/modules/products/products.module").then(
            (m) => m.ProductsModule
          ),
      },
      {
        path: "categories",
        loadChildren: () =>
          import("src-may-12/app/modules/categories/categories.module").then(
      ...
      },
      {
        path: "voucher",
        loadChildren: () =>
          import("src-may-12/app/modules/vouchers/vouchers.module").then(
            (m) => m.VouchersModule
          ),
      },
      {
      ...
      },
      {
        path: "orders/product",
        loadChildren: () =>
          import("src-may-12/app/modules/orders/orders.module").then(
            (m) => m.OrdersModule
          ),
      },

      {
        path: "orders/uber",
        loadChildren: () =>
          import("src-may-12/app/modules/uber/uber.module").then(
            (m) => m.UberModule
          ),
      },
      {
        path: "orders/lessons",
        loadChildren: () =>
          import("src-may-12/app/modules/driver-lesson/driver-lesson.module").then(
      ...
      },
      {
        path: "mail-history",
        loadChildren: () =>
          import("src-may-12/app/modules/mail-history/mail-history.module").then(
  ...
  // },
  {
    path: "consultant",
    loadChildren: () =>
      import("src-may-12/app/modules/consultant/consultants.module").then((m) => m.ConsultantsModule),
  },
  // {
  //   path: "groups",
  //   loadChildren: () =>
  ...
  // },
  {
    ...
    // },
    loadChildren: () =>
      import("src-may-12/app/modules/setting/setting.module").then(
        (m) => m.SettingModule
      ),
  },
  // {
